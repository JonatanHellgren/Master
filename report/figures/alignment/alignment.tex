...
\begin{tikzpicture}[
  ...
  % Draw the cell: 
  \node [cell, minimum height =3.1cm, minimum width=3.1cm] at (0,0){} ;
  \node [cell, minimum height =3.1cm, minimum width=3.1cm] at (4.5,0){} ;
  ...
  \draw [->, thick] (human) -- (-1.6,0);
  \draw [->, thick] (1.55, 0) -- (2.9,0);
  \draw [->, thick] (6.05, 0) -- (6.625, 0);
