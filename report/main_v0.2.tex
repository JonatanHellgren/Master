...
\pagestyle{fancy}
\fancyhf{}
\newgeometry{top=4cm, bottom=4cm,left=2 cm,right=2cm}
...
To be able to understand what artificial intelligence is, it is first required that we agree on what intelligence is. In this report we see intelligence as the ability to accomplish complex goals in a wide variety of environments. 

In recent human history we have seen a massive technological development, our lives today are severally different today compared to a century ago. Most of this development can be seen as the development of tools that we humans can make use of to carry on with increasing future development. In the beginning of our evolutionary history these tools where fire to cook our food and spears and knifes to hunt with. In recent years a new tool has emerged, namely artificial intelligence which we will in this report define as;
\begin{definition}[AI]
