...
What we can see today is a prominent focus on developing AI. With billions of dollars spent on development in 2020, while only around \$50 million on reducing the risks, see \citet{80000}. Even though the field  was aware of this issue before the development of AI started, for example, in a paper written by \citet{Turing51}, we can find the following quote:
\begin{displayquote}
