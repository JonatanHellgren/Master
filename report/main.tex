...
\begin{figure}[H]
  ...
  \]
  \caption{In this figure, $T$ is the transition function defined earlier and 'Right' the action $a_t$, at this timestep. The current state $s_t$ is the left grid, in it the red square at (1,1) is the agent and the red circle at (2,2) is a food object. On the right hand side we can see the state transitioned to $s_{t+1}$.}
