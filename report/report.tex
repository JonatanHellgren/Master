...
The results of the simulation study are in line with other research where it reduces side effects. However, scaling up the impact measurement eventually renders the agent unable to act. Besides this, in a more complex environment, we saw increasing performance. From this, we conclude that a more complex task might suit this impact measurement better by putting more pressure on the agent, resulting in more intelligent behavior. 
